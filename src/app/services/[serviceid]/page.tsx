// import serviceDetails from '@/serviceDB';
...
// const sD: TypeServicesDetails[] = serviceDetails
const servicesDetails: TypeServicesDetails[] = [
  {
    id: 1,
    ...
    details: {
      introduction:
        "We specialize in creating unique, responsive websites tailored to your needs, ensuring seamless user experiences.",
      features: [
        "Responsive design optimized for all devices.",
        "Custom layouts using modern frameworks.",
  ...
  },
  {
    ...
    details: {
      introduction:
        "Our e-commerce solutions are designed to provide a seamless online shopping experience, with robust functionalities and scalability.",
      features: [
        "Secure payment gateway integration.",
        "User-friendly interface for easy navigation.",
        "Inventory and order management system.",
      ],
      technologies: ["Shopify", "WooCommerce", "React", "Firebase"],
      duration: "3-6 weeks",
  ...
  },
  {
    ...
    details: {
      introduction:
        "We craft modern landing pages and portfolio websites to elevate your brand and increase engagement.",
      features: [
  ...
  },
  {
    ...
    details: {
      introduction:
        "Our full-stack development services ensure a cohesive and scalable solution for your business.",
      features: [
        "Custom APIs and backend integration.",
  ...
  },
  {
    ...
    details: {
      introduction:
        "We help businesses modernize their websites and ensure they stay up-to-date with ongoing maintenance services.",
      features: [
        "Full website redesign with modern UI.",
  ...
  },
  {
    ...
    details: {
      introduction:
        "Our UI/UX design service focuses on crafting user-centered designs for an exceptional digital experience.",
      features: [
  ...
  },
  {
    ...
    details: {
      introduction:
        "We provide CMS development services to simplify content management and streamline your workflow.",
      features: [
        "Customizable CMS solutions.",
        "SEO-friendly structures.",
        "Secure and scalable systems.",
      ],
      technologies: ["WordPress", "Custom CMS", "PHP"],
      duration: "3-5 weeks",
  ...
  },
  {
    ...
    details: {
      introduction:
        "We build progressive web apps to provide a smooth and engaging user experience across devices.",
      features: [
        "Offline functionality and caching.",
        "Push notifications for user engagement.",
        "Cross-platform compatibility.",
      ],
      technologies: ["React", "Next.js", "Workbox"],
      duration: "4-6 weeks",
  ...
  },
  {
    ...
    details: {
      introduction:
        "Our SEO services are designed to enhance your website's visibility and drive organic traffic.",
      features: [
        "Technical SEO audits.",
        "Content optimization for keywords.",
        "Analytics and performance tracking.",
      ],
      technologies: ["Google Analytics", "Yoast SEO", "Semrush"],
      duration: "Ongoing",
  ...
  },
  {
    ...
    details: {
      introduction:
        "Our API integration and development services ensure seamless connectivity between your applications.",
      features: [
  ...
  },
  {
    ...
    details: {
      introduction:
        "Our web application development services cater to startups, enterprises, and small businesses, providing cutting-edge solutions tailored to your needs.",
      features: [
  ...
  },
  {
    ...
    details: {
      introduction:
        "Our AI-powered chatbot solutions enable seamless customer support and operational automation for your business.",
      features: [
        "Custom NLP models",
...
export default async function ServicePage({
  ...
  params: Promise<{ serviceId: TypeServicesDetails }>;
}) {
  const servicesId = +(await params).serviceId;
  const service = servicesDetails.find((s) => s.id === servicesId);

  // console.log(service)

  if (!service) return <div>Service Not Fount</div>;

  return (
    <section className="min-h-screen bg-gray- my-20 py-10 px-6">
