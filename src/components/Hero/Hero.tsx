...
function Hero() {
  return (
    <section id='hero' className="flex flex-col md:flex-row-reverse min-h-screen justify-between items-center px-6 md:px-16 py-16 lg:py-24 bg-white">
      {/* Image Section */}
      <div className="w-full md:w-1/2 flex flex-col items-center">
        ...
        <div className="flex mt-6 space-x-4">
          ...
          <Link href="https://facebook.com" className="grayscale hover:grayscale-0">
            <Image src="/assets/images/facebook_5968764.png" alt="Fb Icon" height={40} width={40} />
          </Link>
          <Link href="https://twitter.com" className="grayscale hover:grayscale-0">
            <Image src="/assets/images/twitter_5968830.png" alt="twitter icon" height={40} width={40} />
          </Link>
          <Link href="https://github.com" className="grayscale hover:grayscale-0">
            <Image src="/assets/images/github_14051861.png" alt="github icon" height={40} width={40} />
          </Link>
          <Link href="https://wa.me/923343489702" className="grayscale hover:grayscale-0">
            <Image src="/assets/images/whatsapp_2111728.png" alt="whatsapp icon" height={40} width={40} />
          </Link>
        </div>
      </div>
