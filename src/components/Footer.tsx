    ...
    <footer className="bg-gray-100 text-black py-6">
      <div className="container mx-auto text-center">
        ...
        <div className="flex justify-center space-x-4 mb-4">
          <Link href="https://twitter.com" aria-label="Twitter" className="text-gray-400 hover:text-white">
            <Image src='/assets/images/twitter_5968830.png' alt='' width={20} height={20}/>
          </Link>
          <Link href="https://facebook.com" aria-label="Facebook" className="text-gray-400 hover:text-white">
            <Image src='/assets/images/facebook_5968764.png' alt='' width={20} height={20}/>
          </Link>
          <Link href="https://whatsapp.com" aria-label="whatsapp" className="text-gray-400 hover:text-white">
            <Image src='/assets/images/whatsapp_2111728.png' alt='' width={20} height={20}/>
          </Link>
          <Link href="https://github.com" aria-label="github" className="text-gray-400 hover:text-white">
            <Image src='/assets/images/github_14051861.png' alt='' width={20} height={20}/>
          </Link>
        </div>
