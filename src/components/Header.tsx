...
export default function Header() {
  ...
  return (
    <header className="  bg-white inset-x-0 top-0 z-50">
      ...
      {isMobileMenuOpen && (
        <div
          className="lg:hidden absolute top-0 left-0 right-0 z-50 w-full my-2 mx-2 p-2 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 bg-[#57ff9db4] rounded backdrop-blur-3xl"
          role="dialog"
          aria-modal="true"
